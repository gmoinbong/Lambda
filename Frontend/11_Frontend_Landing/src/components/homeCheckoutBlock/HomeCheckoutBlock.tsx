...
export const HomeCheckoutBlock: FC<Props> = () => {
    const { checkScreen, isMobile } = useScreenDetector();
        ...
        <div className={styles.checkoutBlock}>
            <div className={styles.content}>
                <img
                    ...
                    src={'/assets/background/homeContent.png'}
                    alt="home content"
                />
                <div className={styles.textBlock}>
                    <h2>
                        {checkScreen ? "Tinvio in a heartbeat" : "Check out how it works"}
                    </h2>
                    <p>
                        {isMobile
                            ? <>It’s easy! Exchange messages, create or confirm <br /> orders,  send invoices, and collect payments across <br /> your supply chain —all within one dashboard.</>
