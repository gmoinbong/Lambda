        ...
        <>
            <div className={styles.container}>
                ...
                <div className={styles.grid}>
                    ...
                    <img className={styles.greyBg1} src="/assets/background/greyDiamondbg1.svg" alt="grey bg" />
                    <img className={styles.greyBg2} src="/assets/background/greyDiamondbg1.svg" alt="grey bg" />
                </div>
